    ...
    <div class="add-experience">
        <div class="container">
            <div class="row">
                ...
                <h1 class="Title">Add your experience</h1>
                <p class="title">show your experience to let us know you more</p>
...
export default {
    ...
    methods:{
        submit(){
            ...
            //提交个人经历到数据库
            this.$axios.post("http://localhost:5000/api/profile/experience",this.msgInfo)
            .then((res) => {
                //清空错误
                this.errors = {};
